...
numeric HAVE_PLAN.
recode FL2 (1=0) (2 thru 4 = 1) into .
...
"no", need to compare.
numeric FIN_HEA1.
*FL6 section (4 variables) is asked "yes" and 
numeric FIN_HEA2.
numeric FIN_HEA3. *Corresponds to FL6_1.
numeric FIN_HEA4. 
numeric FIN_HEA5. *FL6_2.
numeric FIN_HEA6. *FL6_3, does not include "in full".
numeric FIN_HEA7. *FL6_4 is similar.

recode FL8_3 (5=1)(4=2)(2=4)(1=5) into FIN_HEA8. *only difference is the word "heavily".
...
numeric FIN_HEA1. *"that is large enough to cover" unplanned expenses.
numeric FIN_HEA2.
numeric FIN_HEA3
numeric FIN_HEA4. 
numeric FIN_HEA5. *FL6_1.
numeric FIN_HEA6. *FL6_2, does not include "in full".
numeric FIN_HEA7. *FL6_4 is similar.

recode FL10_3 (5=1)(4=2)(2=4)(1=5) into FIN_HEA8. *only difference is the word "heavily".
...
recode FL3_3 (5=1)(4=2)(2=4)(1=5) into FIN_HEA4. *doesn't include "and in full".
recode FL3_2 (5=1)(4=2)(2=4)(1=5) into FIN_HEA5.*"to cover for" vs "that is large enough for" unplanned expenses.
