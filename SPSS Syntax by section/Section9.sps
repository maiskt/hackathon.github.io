...
INFML_SERVICE_2"Services received in the informal societies or Welfare/clan group belongs to: receive loan/credit "
INFML_SERVICE_3"Services received in the informal societies or Welfare/clan group belongs to: collect money and give to each member a lump sum (pot) or gift in turn"
INFML_SERVICE_4"Services received in the informal societies or Welfare/clan group belongs to: save and lend money to members and/or non-members to be repaid with interest"
INFML_SERVICE_5"Services received in the informal societies or Welfare/clan group belongs to: periodically distribute all monies held by the group to its members"
INFML_SERVICE_6"Services received in the informal societies or Welfare/clan group belongs to: save together and put the money in an account"
INFML_SERVICE_7"Services received in the informal societies or Welfare/clan group belongs to: make other kinds of investments as a group (e.g., property, business)"
INFML_SERVICE_8"Services received in the informal societies or Welfare/clan group belongs to: invest in the stock market as a group".
...
recode IFI20_1 (1=1)(else=0) into INFML_SERVICE_1.
recode IFI20_2 (1=1)(else=0) into INFML_SERVICE_2.
recode IFI20_3 (1=1)(else=0) into INFML_SERVICE_3.
recode IFI20_4 (1=1)(else=0) into INFML_SERVICE_4.
recode IFI20_5 (1=1)(else=0) into INFML_SERVICE_5.
recode IFI20_6 (1=1)(else=0) into INFML_SERVICE_6.
recode IFI20_7 (1=1)(else=0) into INFML_SERVICE_7.
recode IFI20_8 (1=1)(else=0) into INFML_SERVICE_8.
...
recode IFI20_1 (1=1)(else=0) into INFML_SERVICE_1.
NUMERIC INFML_SERVICE_2.
recode IFI20_2 (1=1)(else=0) into INFML_SERVICE_3.
NUMERIC INFML_SERVICE_4.
recode IFI20_3 (1=1)(else=0) into INFML_SERVICE_5.
recode IFI20_4 (1=1)(else=0) into INFML_SERVICE_6.
NUMERIC INFML_SERVICE_7.
NUMERIC INFML_SERVICE_8.
...
NUMERIC  INFML_SERVICE_1.
NUMERIC  INFML_SERVICE_2.
NUMERIC  INFML_SERVICE_3.
NUMERIC  INFML_SERVICE_4.
NUMERIC  INFML_SERVICE_5.
NUMERIC  INFML_SERVICE_6.
NUMERIC  INFML_SERVICE_7.
NUMERIC  INFML_SERVICE_8.
