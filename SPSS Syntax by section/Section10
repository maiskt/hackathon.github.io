...
/keep= SBJNUM COUNTRY YEAR LOAN LOAN_CURRENT LOAN_INTEREST LOAN_INFML LOAN_FORMAL LOAN_STORE LOAN_CREDITCARD LOAN_BANK LOAN_MM LOAN_MFI LOAN_COOP LOAN_MLENDER LOAN_PAWN LOAN_GROUP LOAN_POST LOAN_PAYBANK LOAN_SACCO LOAN_EMERGENCY LOAN_DAILY LOAN_BUSINESS LOAN_HOME LOAN_AGRIC.
