...
compute ppi_score2 = sum(young, school, female, floor, roof, bike, radio, lantern, iron, table).
freq ppi_score.

recode ppi_score2 (0 thru 14 = 100) (15 thru 29 = 99.7) (30 thru 34 =99.3)
...
compute POVERTY1 = 0.
if (ppi_score2 <= 66) POVERTY1= 1.

*Need double check.
recode ppi_score2 (0 thru 4 = 99.4) (5 thru 9 = 99.1) (10 thru 14 =99.2) (15 thru 19 = 96.9) (20 thru 29 =90.6) (30 thru 34 = 88.6) (35 thru 39 = 77.7) (40 thru 44 = 70.5)
...
if (ppi_score2 <= 52) ppi_cutoff_125 = 1.
