...
* This data is only available 2014-2016.
...
+ 0 = Neither Agree nor Disagree/Disagree/Strongly Disagree

Notes:
* These variables were converted from 4 and 5-point Likert scale questions. For both, the two positive responses (agree and strongly agree) were coded as "Yes".
* FIN_HEA1 only exists for 2018 data.
* FIN_HEA3 through FIN_HEA5 exist in 2014, 2017, and 2018 data.
* Only FIN_HEA8 and FIN_HEA10 exist for 2015-2018.
* For FIN_HEA4, *year needed*, a difference in wording: "pay bills on time *and in full*. Since this is more specific, respondents may have agreed less strongly.
*  For FIN_HEA8 in 2015 and 2016, a difference in wording:"friends and family rely *heavily*" on them. Since this is more specific, respondents may have agreed less strongly.
* In 2014, the response options were a range of "Always" to "Never", rather than "Strongly Agree" to "Strongly Disagree". It is uncertain if this would lead to a repsonse bias.
